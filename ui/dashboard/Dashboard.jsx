...
const Dashboard = ({ userId }) => {
  ...
  const renderQuickActions = () => (
    <div className="dashboard-card actions-card" aria-labelledby="actions-heading">
      ...
      {isMobile && (
        <button className="more-actions-btn">Show More Actions</button>
      )}
    </div>
  );
  ...
  const renderRecentActivity = () => (
    <div className="dashboard-card activity-card" aria-labelledby="activity-heading">
      <div className="card-header">
      ...
      <div className="activity-tabs">
        ...
        <button 
          className={`activity-tab ${activeTab === 'deployments' ? 'active' : ''}`}
        ...
        <button 
          className={`activity-tab ${activeTab === 'workflows' ? 'active' : ''}`}
      ...
      <ul className="activity-list" role="tabpanel">
        {recentActivity
          .filter(activity => {
            if (activeTab === 'overview') return true;
            if (activeTab === 'deployments') return activity.type === 'deployment';
            if (activeTab === 'workflows') return activity.type === 'workflow';
            ...
            <li key={activity.id} className={`activity-item ${activity.type}`}>
              ...
              <div className="activity-content">
                <div className="activity-header">
                  ...
                  <span className="activity-time" title={formatTime(activity.timestamp)}>
                    {timeAgo(activity.timestamp)}
                  </span>
                </div>
                <p className="activity-details">{activity.details}</p>
              </div>
              <button className="activity-action-btn" aria-label={`View details for ${activity.title}`}>
      ...
      {recentActivity.filter(activity => {
        ...
        <div className="no-activity">
          <p>No {activeTab !== 'overview' ? activeTab : 'activity'} to display</p>
        </div>
      )}
    </div>
  );
      ...
      <div className="dashboard-container">
        <div className="dashboard-header">
          ...
          <div className="dashboard-actions">
            <button className="refresh-dashboard-btn" aria-label="Refresh dashboard">
